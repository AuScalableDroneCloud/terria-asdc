...
import dataStoriesImg from "terriajs/wwwroot/images/data-stories-getting-started.jpg"
...
import BadgeBar from "terriajs/lib/ReactViews/BadgeBar";
import measureElement from "terriajs/lib/ReactViews/HOCs/measureElement";
import Icon, { StyledIcon } from "terriajs/lib/Styled/Icon";
import VideoGuide from "terriajs/lib/ReactViews/Map/Panels/HelpPanel/VideoGuide";
import { getShareDataForStories } from "./BuildShareLink.js";
import SharePanel from "terriajs/lib/ReactViews/Map/Panels/SharePanel/SharePanel.jsx";
import Styles from "terriajs/lib/ReactViews/Story/story-builder.scss";
import Story from "terriajs/lib/ReactViews/Story/Story";
import StoryEditor from "terriajs/lib/ReactViews/Story/StoryEditor.jsx";
import {
  Category,
  StoryAction
  ...
  createReactClass({
    ...
    captureStory(story) {
      story.shareData = JSON.parse(
        JSON.stringify(
          getShareDataForStories(this.props.terria, this.props.viewState, {
