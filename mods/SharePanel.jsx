...
import StorySharePanel from "terriajs/lib/ReactViews/Map/Panels/SharePanel/StorySharePanel";
import {
  Category,
  ShareAction
} from "terriajs/lib/Core/AnalyticEvents/analyticEvents";
import { downloadImg } from "terriajs/lib/ReactViews/Map/Panels/SharePanel/Print/PrintView";
...
const SharePanel = observer(
  createReactClass({
    ...
    renderContentForStoryShare() {
      ...
      return (
        <Choose>
            <When condition={this.state.showMakeODMDatasetsPublicQuestion}>
              <div id="share-question">
                ...
                <div id="share-question-buttons">
                  <button 
                    id="share-question-yes" 
                    className={Styles.printButton}
                    style={{width:45}}
                    title="Clicking Yes will make all the WebODM tasks added to the workbench public"
                    onClick={this.makeWebODMDatasetsPublic}
                  >
                      Yes
                  </button>
                  <button 
                    id="share-question-no" 
                    className={Styles.printButton}
                    style={{width:45}}
                    title="Clicking No will require all the selected WebODM tasks to get manually shared with the user receiving the link"
                    onClick={()=>{this.setState({showMakeODMDatasetsPublicQuestion : false})}}
                  >
                      No
                  </button>
                </div>
    ...
    makeWebODMDatasetsPublic(){
      var makePublicPromises = [];

      this.setState({showMakeODMDatasetsPublicQuestion : false})
